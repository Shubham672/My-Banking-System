		...
		<table class="flat-table-1">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<form action="user.php" method="post" class="view">
							<button class="button1" type="submit" name="name" value="SanjuKing">View</button>
						</form>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<form action="user.php" method="post" class="view">
							<button class="button1" type="submit" name="name" value="Mr_Joyee">View</button>
						</form>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<form action="user.php" method="post" class="view">
							<button class="button1"type="submit" name="name" value="Mr_Bhide">View</button>
						</form>
					</td>
				</tr>
			</tbody>
